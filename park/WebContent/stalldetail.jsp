				...
				<div class="app-content">
						<div class="card">
												<div class="pro-img-box">
													<img src="img/park/01.png" alt="" id="parkimg">
													<label style="width:600px;height:170px;font-size: 24px;" id="parkcontent">asiodjfoiasdjfoiasjdfoijasodijfoaisjdfoiajsdofjiaosidjfoaisjdfoijasodijfoaisdjfoaisjdf</label>
													<div class="shop-details">
														<a id="toindentxd" title="下单" class="adtocart" >
															<i class="fa fa-shopping-cart"></i>
														</a>
														<a title="点赞" class="adtocart">
															<i class="fa fa-thumbs-up"></i>
														</a>
														<a title="差评" class="adtocart">
												...
												<div class="card-body text-center">
													<h4>
														<a href="shop-cart" class="pro-title" id="parkname">
															Chudidhar停车场
														</a>
													</h4>
													<p class="price" id="parkprice">$52.00</p>
												</div>
											</div>
				</div>
...
$(function () {
	...
	$.get("stall/queryDetail", {id:id}, function (data) {
		if(data.tb!=null){
			$('#parkimg').attr("src",data.tb.img);
			$('#parkcontent').html(data.tb.parkcontent);
			$('#parkname').html(data.tb.name);
			$('#parkprice').html("$"+data.stallprice);
			$('#toindentxd').attr("href","/park/toindent.jsp?id="+data.stallid);
		}
	});
});
