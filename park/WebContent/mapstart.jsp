...
<body class="app ">
					...
					<div class="section-body">
                        ...
                        <div class="col-lg-12">
                            <div class="card m-b-20">
									<h5 class="card-header">中国 地图</h5>
									<div class="card-body">
										<div id="chn" class="stateh h-400"></div>
									</div>
								</div>
							</div>
						</div>
	...
	<!-- Vector Plugin -->
	<script
		src="${ pageContext.request.contextPath }/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
	<script
		src="${ pageContext.request.contextPath }/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<script
		src="${ pageContext.request.contextPath }/assets/plugins/jvectormap/gdp-data.js"></script>
	<script
		src="${ pageContext.request.contextPath }/assets/plugins/jvectormap/jquery-jvectormap-us-aea-en.js"></script>
	<script
		src="${ pageContext.request.contextPath }/assets/plugins/jvectormap/jquery-jvectormap-uk-mill-en.js"></script>
	<script
		src="${ pageContext.request.contextPath }/assets/plugins/jvectormap/jquery-jvectormap-au-mill.js"></script>
	<script
		src="${ pageContext.request.contextPath }/assets/plugins/jvectormap/jquery-jvectormap-cn-mill-en.js"></script>
	<script
		src="${ pageContext.request.contextPath }/assets/js/jvectormap.js"></script>
</body>
</html>
