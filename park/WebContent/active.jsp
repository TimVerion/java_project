				...
				<div class="app-content">
					<section class="section">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">激活信息</li>
						</ol>
						<div class="row">
							<div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
								<div class="card">
									...
									<div class="card-body">
										<form class="form-horizontal" action="saveshow" method="post">
											<div class="form-group row">
												<label for="inputName" class="col-md-3 col-form-label">头像</label>
												<div class="col-md-9">
													<select class="form-control" id="show_img" name="show_img">
														<option value="assets/img/avatar/avatar-2.jpeg">职场男</option>
														<option value="assets/img/avatar/avatar-1.jpeg">职场女</option>
														<option value="assets/img/avatar/avatar-3.jpeg">文艺女</option>
														<option value="assets/img/avatar/avatar-4.jpeg">文艺男</option>
														<option value="assets/img/avatar/avatar-5.jpeg">温馨女</option>
														<option value="assets/img/avatar/avatar-6.jpg">狂野男</option>
													</select>
												</div>
											</div>
											<div class="form-group row">
												<label for="inputEmail3" class="col-md-3 col-form-label">座右铭</label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="show_sign"
														id="show_sign" placeholder="hello world!" required>
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-md-3 col-form-label">昵称</label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="show_name"
														id="show_name" placeholder="aim" required>
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-md-3 col-form-label">公司名</label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="show_company"
														id="show_company" placeholder="阿里巴巴" required>
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-md-3 col-form-label">公司职位</label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="show_post"
														id="show_post" placeholder="网站开发师" required>
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-md-3 col-form-label">住址</label>
												<div class="col-md-9">
													<input type="text" class="form-control" name="show_address"
														id="show_adress" placeholder="文学家园1号楼" required>
												</div>
											</div>
							...
							<div class="col-lg-12 col-xl-4">
								<div class="card">
									<div class="card-body box">
										...
										<div class="img">
											<img src="assets/img/avatar/avatar-1.jpeg.jpg" id="admin_img">
										</div>
										<h2 id="admin_name">
											Jessica Lee<br>
										</h2>
											<span id="admin_post">Web Designer</span>
										<p class="mb-3" id="admin_sign"></p>
						...
						<div class="row">
									...
									<div class="card-body">
										<form class="form-horizontal" method="post" action="saveinfo">
											...
											<div class="form-group row mb-0">
												<div class="col-md-9">
													<input type="submit" class="btn btn-info" id="c_save"
														value="保存">
												</div>
											</div>
							...
							<div class="col-lg-12 col-xl-6 col-md-12 col-sm-12">
								<div class="card">
									<div class="card-header">
										<h4>车辆信息</h4>
										<a href="${ pageContext.request.contextPath }/nopay"">已注册车辆信息查询</a>
									</div>
									<div class="card-body">
										<form class="form-horizontal" method="post" action="savecar">
											<div class="form-group row">
												<label class="col-md-3 col-form-label">车辆类型</label>
												<div class="col-md-9">
													<input class="form-control" type="text" name="car_name"
														id="car_name" placeholder="奥迪">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">车牌号</label>
												<div class="col-md-9">
													<input class="form-control" type="text" name="car_num"
														id="car_num" placeholder="京PH3300x">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">车主</label>
												<div class="col-md-9">
													<input class="form-control" type="text" name="car_admin"
														id="car_admin">
												</div>
											</div>
											<div class="form-group row mb-0">
											...
											<div class="form-group row mb-0">
												<div class="col-md-9">
													<input type="submit" class="btn btn-info" id="carbtn"
														value="保存">
												</div>
											</div>
										</form>
		...
		$(function() {
			$.get("client/writeInfo", {}, function(data) {
				if (data.cs != null) {
					...
					//额外的
					$('#admin_img').attr("src",data.cs.img);
					$('#admin_name').html(data.cs.name);
					$('#admin_sign').html(data.cs.sign);
					$('#admin_post').html(data.cs.post);
				}
			});
			$.get("client/writeActive", {}, function(data) {
				if (data.cs != null) {
					$('#show_name').val(data.cs.name);
					$('#show_sign').val(data.cs.sign);
					$('#show_company').val(data.cs.company);
					$('#show_adress').val(data.cs.adress);
					$('#show_post').val(data.cs.post);
					$('#showbtn').css("background", "#c08eaf");
				}
				if (data.cf != null) {
					$('#c_name').val(data.cf.name);
					$('#c_email').val(data.cf.mail);
					$('#c_sex').val(data.cf.sex);
					$('#c_phone').val(data.cf.phonenum);
					$('#c_name').val(data.cf.sign);
					$('#c_save').css("background", "#c08eaf");
				}
				if (data.car != null) {
					$('#car_name').val(data.car.carbrand);
					$('#car_num').val(data.car.carnum);
					$('#car_admin').val(data.car.person);
					$('#car_type').val(data.car.cartype);
					$('#carbtn').css("background", "#c08eaf");
				}
			});
			$('#show_img').blur(function(){
				$('#admin_img').attr("src",$(this).val());
			});
			$('#show_name').blur(function(){
				$('#admin_name').html($(this).val());
			});
			$('#show_post').blur(function(){
				$('#admin_post').html($(this).val());
			});
			$('#show_sign').blur(function(){
				$('#admin_sign').html($(this).val());
			});
