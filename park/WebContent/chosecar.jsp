			...
			<div class="main-wrapper" >
				...
				<section class="section">
                    	<ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">选择车辆</li>
                        </ol>
				<div class="row">
				<c:forEach items="${cars}" var="car" >
							<div class="col-lg-6 col-xl-3 col-md-12 col-12">
								<div class="card overflow-hide">
									<div class="card-body bg-transaprent cover-image " data-image-src="assets/img/news/img11.jpg">
										<div class="dash2 text-center">
											<div class="text-white">
										<a href="getdata?ispay=${ispay}&cid=${car.id}">选择</a>
										<a href="delcar?ispay=${ispay}&cid=${car.id}">删除</a>
												<small class="float-left ">${car.carbrand}</small>
												<h3 class="float-right mb-0">${car.carnum }</h3>
												<h5 class="float-right mb-0">${car.person}</h5><br/>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row" style="width:100%">
							<div class="col-md-12 col-12 col-lg-12">
								<div class="card">
									<h4>去<a href="${ pageContext.request.contextPath }/active.jsp">增加</a>车辆信息</h4>
								</div>
							</div>
						</div>
						<div class="row" style="width:100%">
							<div class="col-md-12 col-12 col-lg-12">
								<div class="card">
									...
									<div class="card-body">
										<div id="timeline-chart" class="overflow-hidden"></div>
									</div>
								</div>
							</div>
						</div>
...
<script src="${ pageContext.request.contextPath }/assets/plugins/morris/raphael.min.js"></script>
	...
	<!--Scripts js-->
		...
		<script src="${ pageContext.request.contextPath }/assets/js/apexcharts.js"></script>
		<script src="${ pageContext.request.contextPath }/assets/js/dashboard2.js"></script>

		<!--OtherCharts js-->
		<script src="${ pageContext.request.contextPath }/assets/js/othercharts.js"></script>
